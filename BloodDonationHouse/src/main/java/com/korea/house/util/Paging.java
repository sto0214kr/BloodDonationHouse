...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/house/resources/img/rigth.webp' width='25px'></a>");
		}
		else
			sb.append("<img src='/house/resources/img/rigth.webp' width='25px'>");
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				sb.append("&nbsp;<b><font color='#aaaaff'>");
				sb.append(i);
				sb.append("</font></b>");
			}
			else{//현재 페이지가 아니면
				sb.append("&nbsp;<a style='color:#C8C6C6' href='"+pageURL+"?page=");
				sb.append(i);
				sb.append("'>");
				sb.append(i);
				sb.append("</a>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='/house/resources/img/left.webp' width='25px'></a>");
		}
		else
			sb.append("<img src='/house/resources/img/left.webp' width='25px'>");
//---------------------------------------------------------------------------------------------------------------------	    
